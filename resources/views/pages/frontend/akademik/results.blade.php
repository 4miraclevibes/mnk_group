    ...
    <div class="container">
        <div class="page-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="mb-2">
                        <i class="fas fa-history me-2"></i>Riwayat Hasil Ujian
                    </h1>
                    <p class="mb-0">Semua hasil ujian yang pernah Anda kerjakan</p>
                </div>
                        ...
                        <div class="result-info">
                            ...
                            <div class="result-meta">
                                ...
                                <div class="meta-item">
                                    ...
                                    <span>{{ $result->examSubject->examType->section }}</span>
                                </div>
                            </div>
                        </div>
        ...
        @else
            <div class="empty-state">
                ...
                <p class="text-muted mb-4">Anda belum pernah mengerjakan ujian. Mulai ujian pertama Anda sekarang!</p>
